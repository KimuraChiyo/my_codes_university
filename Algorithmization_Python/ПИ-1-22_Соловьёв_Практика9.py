...
# 9
print("\n9. Дана матрица размера M × N и целое число K (1 ≤ K ≤ M). Найтисумму и произведение элементов K-й строки данной матрицы.")
m, n = int(input("Введите m: ")), int(input("Введите n: "))
...
# 10
print("\n10. Дана матрица размера M × N и целое число K (1 ≤ K ≤ N). Найтисумму и произведение элементов K-го столбца данной матрицы.")
m, n = int(input("Введите m: ")), int(input("Введите n: "))
k = int(input("Введите k: ")) - 1
matrix = [[randint(1, 100) for j in range(1, n + 1)] for i in range(1, m + 1)]
[print(*row, sep='\t') for row in matrix]
...
# 14
print("\n14. Дана матрица размера M × N и целые числа K1 и K2 (1 ≤ K1 < K2 ≤ M). Поменять местами строки матрицы с номерами K1 и K2.")
m, n = int(input("Введите m: ")), int(input("Введите n: "))
...
# 15
print("\n15. Дана матрица размера M × N и целые числа K1 и K2 (1 ≤ K1 < K2 ≤ N). Поменять местами столбцы матрицы с номерами K1 и K2.")
m, n = int(input("Введите m: ")), int(input("Введите n: "))
k, l = int(input("Введите k: ")) - 1, int(input("Введите l: ")) - 1
matrix = [[randint(1, 100) for j in range(1, n + 1)] for i in range(1, m + 1)]
[print(*row, sep='\t') for row in matrix]
...
# 16
print("\n16. Дана матрица размера M × N. Преобразовать матрицу, поменяв местами минимальный и максимальный элемент в каждой строке.")
m, n = int(input("Введите m: ")), int(input("Введите n: "))
matrix = [[randint(1, 100) for j in range(1, n + 1)] for i in range(1, m + 1)]
[print(*row, sep='\t') for row in matrix]
print()
...
# 17
print("\n17. Дана матрица размера M × N. Преобразовать матрицу, поменяв местами минимальный и максимальный элемент в каждом столбце.")
m, n = int(input("Введите m: ")), int(input("Введите n: "))
matrix = [[randint(1, 100) for j in range(1, n + 1)] for i in range(1, m + 1)]
[print(*row, sep='\t') for row in matrix]
print()
